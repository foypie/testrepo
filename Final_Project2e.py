...
#wget https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/JEjmIeVAHVV0oQdqHi5q8Q/DV0101EN-Final-Assign-Part-2-Questions.py
import dash
import itertools
...
def update_output_container(selected_statistics, input_year):
    if selected_statistics == 'Yearly Statistics':
        # Filter the data for recession periods
        yearly_data = data[data['Recession'] == input_year]
...
# Plot 4 Develop a Bar chart for the effect of unemployment rate on vehicle type and sales
 average_sales = df.groupby(('Vehicle_Type')['Unemployment_Rate'].mean().reset_index()                           
        R_chart4  = dcc.Graph(
            figure=px.bar(
		x= ['Unemployment_Rate'],
		y= ['Automobile_Sales'],
